...
```{r ans71}
# failRate
logicsubject <- sampledTranscriptData$科目名稱=="科目204" 
logicsubjectandfail <- sampledTranscriptData$學期成績<60 &logicsubject
failRate<- sum(logicsubjectandfail)/length(logicsubject)
failRate
```
...
```{r ans75}
# studentGPA
studentscore1 <- (sampledTranscriptData$學號=="410073409b" & sampledTranscriptData$學期成績&
                    sampledTranscriptData$學年==101)*sampledTranscriptData$學分數
studentscore2 <- (sampledTranscriptData$學號=="410073409b" & sampledTranscriptData$學分數 &
                     sampledTranscriptData$學年==101)
studentGPA <- studentscore1/studentscore2
studentGPA
```
